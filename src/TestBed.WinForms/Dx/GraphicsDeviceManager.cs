...
namespace TestBed.WinForms.Dx
{
    ...
    public class GraphicsDeviceManager : Component, IGraphicsDeviceManager, IGraphicsDeviceService
    {
        ...
        public GraphicsDeviceManager(Game game)
        {
            ...
            PreferredBackBufferFormat = SharpDX.DXGI.Format.R8G8B8A8_UNorm;
        ...
        private int CalculateRankForFormat(SharpDX.DXGI.Format format)
        {
        ...
        private int CalculateFormatSize(SharpDX.DXGI.Format format)
        {
            switch (format)
            {
